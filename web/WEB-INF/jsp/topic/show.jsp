...
<div id="MainArea">
    ...
    <center>
        <div class="ItemBlock_Title1" style="width: 98%">
            ...
            <font class="MenuPoint"> &gt; </font>
            <s:a action="forum_show?id=%{#topic.forum.id}&pageNow=1">${topic.forum.name}</s:a>
            <font class="MenuPoint"> &gt;&gt; </font>
            帖子阅读
        ...
        <div class="ForumPageTableBorder dataContainer" datakey="replyList">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr valign="bottom">
                    ...
                    <td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
                        ...
                        <a href="${pageContext.request.contextPath}/topic_modifyType?id=${topic.id}&op=1&forumId=${topic.forum.id}" onClick="return confirm('要把本主题设为精华吗？')"><img border="0"
                                                                                 src="${pageContext.request.contextPath}/style/images/topicType_1.gif"/>精华</a>
                        <a href="${pageContext.request.contextPath}/topic_modifyType?id=${topic.id}&op=2&forumId=${topic.forum.id}" onClick="return confirm('要把本主题设为置顶吗？')"><img border="0"
                                                                                 src="${pageContext.request.contextPath}/style/images/topicType_2.gif"/>置顶</a>
                        <a href="${pageContext.request.contextPath}/topic_modifyType?id=${topic.id}&op=0&forumId=${topic.forum.id}" onClick="return confirm('要把本主题设为普通吗？')"><img border="0"
                                ...
                                <ul class="TopicFunc">
                                    ...
                                    <li class="TopicSubject">
                                        <img width="19" height="19"
                                             src="${pageContext.request.contextPath}/style/images/face/${topic.emoji}.gif"/>
                                            ${topic.title}
                                    </li>
                                </ul>
                            </td>
                            ...
                            <td class="Footer" height="28" align="center" valign="bottom">
                                <ul style="margin: 0px; width: 98%;">
                                    <li style="float: left; line-height:18px;"><font color=#C30000>[楼主]</font>
                                        <s:date name="%{#topic.pushTime}" format="yyyy-MM-dd HH:mm:ss"/>
                                    </li>
            ...
            <!-- ~~~~~~~~~~~~~~~ 显示回复列表 ~~~~~~~~~~~~~~~ -->
            <c:forEach var="reply" items="${pageBean.list}" varStatus="status">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <ul class="TopicFunc">
                                    ...
                                    <li class="TopicSubject">
                                        <img width="19" height="19"
                                             src="${pageContext.request.contextPath}/style/images/face/${reply.emoji}.gif"/>
                                            ${reply.title}
                                    </li>
                                </ul>
                            </td>
                            ...
                            <td class="Footer" height="28" align="center" valign="bottom">
                                <ul style="margin: 0px; width: 98%;">
                                    <li style="float: left; line-height:18px;"><font
                                            color=#C30000>[${pageBean.beginPage + status.count}楼]</font>
                                        <s:date name="%{reply.pushTime}" format="yyyy-MM-dd HH:mm:ss"/>
                                    </li>
                                    <li style="float: right;"><a href="javascript:scroll(0,0)">
                                        <img border="0" src="${pageContext.request.contextPath}/style/images/top.gif"/></a>
                                    </li>
        ...
        <script type="text/javascript">
            function gotoPage(pageNum) {
                window.location.href = "topic_show.action?id=${id}&pageNow=" + pageNum;
            }
        </script>
    ...
    <div class="QuictReply">
        <s:form action="reply_add.action?topicId=%{#topic.id}">
                ...
                <table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
                    <tr height="30" class="Tint">
                        ...
                        <td class="no_color_bg">
                            <input type="text" name="title" class="InputStyle" value="${topic.title}"
                                   style="width:90%"/>
                        </td>
                    </tr>
                    <tr height="30" class="Tint">
