...
<div id="StatusBar">
    <div id="Online">
    	在线人员：共 <span class="OnlineUser" id="onlineUserNum">${onlineNum}</span> 人<span class="OnlineView">
        <a href="javascript:void(0)">[查看在线名单]</a>
</span></div>

    <div id="Info">
    	<a href="http://www.itcast.cn" title = "sheeran首页" target=_blank >sheeran首页</a> |
        <a href="http://bbs.itcast.cn" title = "sheeranBBS" target=_blank >sheeranBBS</a>
    </div>
